...
const menuItems = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { label: '장비 매입', href: '/equipment' },
      { label: '폐기 처리', href: '/disposal' },
      { label: '통합 솔루션', href: '/solutions' },
    ],
  },
  {
    label: '장비 안내',
        ...
        <div className="container">
          <div className="flex items-center justify-between h-10 text-sm">
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
              ...
              {COMPANY_CONTACTS.map(({ role, phone }, i) => (
                <span key={phone} className="flex items-center gap-3">
                  {i > 0 && <span className="text-white/50 hidden sm:inline">|</span>}
                  <a href={telHref(phone)} className="hover:text-primary-100 text-xs sm:text-sm whitespace-nowrap">
                    {role} {phone}
                  </a>
                </span>
              ))}
