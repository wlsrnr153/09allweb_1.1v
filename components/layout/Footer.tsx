          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <a href="tel:02-1234-5678" className="text-white hover:text-primary-400 font-semibold">
                    02-1234-5678
                  </a>
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info@09all.com" className="hover:text-primary-400">
                  info@09all.com
                </a>
              </li>
              <li className="flex items-start gap-2">
