        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            <div className="text-2xl font-bold mb-4">
              <span className="text-primary-400">09</span>
              <span className="text-white">all</span>
            </div>
            <p className="text-sm text-gray-400 mb-4 leading-relaxed">
              {COMPANY_LEGAL_NAME_FULL} · <br />
              연구장비 매입 전문 · {SITE_BRAND_NAME}
            </p>
          ...
          {/* 빠른 링크 */}
          <div>
            <h3 className="text-white font-bold mb-4">빠른 링크</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
                  ...
                  <div className="space-y-1">
                    {COMPANY_CONTACTS.map(({ role, phone }) => (
                      <a
                        key={phone}
                        href={telHref(phone)}
                        className="block text-white hover:text-primary-400 font-semibold"
                      >
                        {role} {phone}
                      </a>
                    ))}
              ...
              <li className="flex items-start gap-2">
                ...
                <a href={`mailto:${COMPANY_EMAIL}`} className="hover:text-primary-400">
                  {COMPANY_EMAIL}
                </a>
              </li>
              <li className="flex items-start gap-2">
          ...
          {/* 인증 마크 */}
          <div>
            <h3 className="text-white font-bold mb-4">인증 및 파트너</h3>
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gray-800 rounded-lg p-3 text-center text-xs">
                환경부 장관상 수상
              </div>
              <div className="bg-gray-800 rounded-lg p-3 text-center text-xs">
                여성기업
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <span>|</span>
              <Link href="/privacy" className="hover:text-gray-300 font-semibold">
                개인정보처리방침
              </Link>
            </div>
            <div className="text-center md:text-right">
              <p>© {currentYear} 09all. All rights reserved.</p>
            </div>
          </div>
          <div className="mt-4 text-xs text-gray-600 text-center md:text-left">
            <p>
              대표자: 엄성희 | 사업자등록번호: 150-07-00041 
