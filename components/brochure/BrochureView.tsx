        ...
        <div className="max-w-4xl mx-auto px-12 py-16">
          ...
          <div className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-2xl p-8 mb-12">
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              <strong className="text-primary-600">09all(구올)</strong>은 2004년 설립 이래 20년간 연구장비 매입 분야에서 
              최고의 전문성과 신뢰를 쌓아온 대한민국 대표 연구장비 전문 기업입니다.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 mb-12">
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="text-gray-900">09all (구올)</div>
              </div>
              <div className="flex items-start">
              ...
              <div className="flex items-start">
                ...
                <div className="text-gray-900">홍길동</div>
              </div>
              <div className="flex items-start">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div className="text-gray-900">02-1234-5678</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-xl">02-1234-5678</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center text-2xl">📠</div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-xl">info@09all.com</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center text-2xl">💬</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="text-sm text-primary-100 mb-2">지하철</div>
                  <div className="font-semibold">2호선 강남역 3번 출구 도보 5분</div>
                </div>
                <div>
                  <div className="text-sm text-primary-100 mb-2">버스</div>
                  <div className="font-semibold">간선 146, 740 / 지선 3412, 4318</div>
                </div>
                <div>
