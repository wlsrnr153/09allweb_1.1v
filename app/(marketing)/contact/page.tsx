              ...
              <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      {COMPANY_CONTACTS.map(({ role, phone }) => (
                        <a
                          key={phone}
                          href={telHref(phone)}
                          className="block font-semibold text-lg hover:text-primary-600"
                        >
                          {role} {phone}
                        </a>
                      ))}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${COMPANY_EMAIL}`} className="font-semibold hover:text-primary-600">
                      {COMPANY_EMAIL}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="font-semibold">{COMPANY_ADDRESS}</div>
                  </div>
                </div>
              </div>
