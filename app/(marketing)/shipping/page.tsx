...
export default function ShippingPage() {
  const services = [
    ...
    {
      title: '수거 안내',
      description: '수거 안내 사항',
      icon: '💰',
      details: [
        '장비를 수거하기 전에 개인 데이터나 중요한 정보가 있다면 미리 말씀해주세요.',
        '장비의 부속품을 함께 준비해주시면 더 정확한 평가가 가능합니다.',
    ...
    },
    {
      ...
      icon: '📅',
      details: [
        '평일 시간 조율 후 수거(시간 관계 없음)',
        '주말 및 공휴일 수거 가능 (추가 비용 없음)',
        '사전 일정 조율로 원하시는 시간에 수거',
        '긴급한 수거의 경우 지역별 상담 후 결정',
      ],
        ...
        <div className="container">
          <div className="bg-white rounded-xl shadow-md p-8">
            ...
            <ul className="space-y-3 text-gray-700">
              {[
                '장비를 수거하기 전에 개인 데이터나 중요한 정보가 있다면 미리 말씀해주세요(하드 천공 가능)',
      ...
      <div className="container py-12">
        <div className="bg-gradient-to-br from-primary-600 to-primary-700 text-white rounded-xl shadow-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <span className="block">전화 신청</span>
